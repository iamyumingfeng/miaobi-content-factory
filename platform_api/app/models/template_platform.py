...
from sqlalchemy import Column, BigInteger, String, DateTime, Integer, ForeignKey, JSON, UniqueConstraint, Index
...
class TemplatePlatform(Base):
    ...
    __table_args__ = (
        UniqueConstraint('owner_operator_id', 'name', name='uq_template_platform_owner_name'),
