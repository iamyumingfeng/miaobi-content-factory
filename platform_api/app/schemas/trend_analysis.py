...
class DistributionTrendResponse(BaseModel):
    ...
    distributed_compare: Optional[ComparisonData] = Field(
        default=None, description="分发量对比"
    )
    published_compare: Optional[ComparisonData] = Field(
        default=None, description="发布量对比"
    )
...
class PublishTrendResponse(BaseModel):
    ...
    generated_compare: Optional[ComparisonData] = Field(
        default=None, description="生成量对比"
    )
    published_compare: Optional[ComparisonData] = Field(
        default=None, description="发布量对比"
    )
