...
class SuperAdminUpdate(BaseModel):
    ...
    nickname: Optional[str] = Field(
        default=None, description="昵称", min_length=1, max_length=100
    )
...
class OperatorBase(UserBase):
    ...
    display_name: Optional[str] = Field(default=None, description="自定义昵称")
    status: str = Field(default="active", description="状态：active / disabled")
    user_positioning: Optional[str] = Field(
        default=None, description="账号的自媒体运营定位"
    )
...
class OperatorUpdate(BaseModel):
    ...
    nickname: Optional[str] = Field(
        default=None, description="管理备注名", min_length=1, max_length=100
    )
    display_name: Optional[str] = Field(
        default=None, description="自定义昵称", min_length=1, max_length=100
    )
    status: Optional[str] = Field(
        default=None, description="状态：online / offline / disabled"
    )
    user_positioning: Optional[str] = Field(
        default=None, description="账号的自媒体运营定位"
    )
...
class SubUserBase(UserBase):
    ...
    fan_profile: Optional[str] = Field(
        default=None, description="粉丝画像（年龄/职业/地域/需求/偏好/禁忌等）"
    )
    # 要点2【账号定位】：核心赛道、核心价值、目标受众匹配、账号层级等
    user_positioning: Optional[str] = Field(
        default=None, description="账号定位（核心赛道/价值/受众/层级等）"
    )
    user_category: Optional[str] = Field(default=None, description="账号的运营分类")
    # 要点3【内容风格】：语气、排版逻辑、呈现形式、核心调性、固定句式/口头禅等
    content_style: Optional[str] = Field(
        default=None, description="内容风格（语气/排版/调性/句式等）"
    )
...
class SubUserCreate(BaseModel):
    ...
    password: Optional[str] = Field(
        default=None, description="密码（留空则自动生成）", min_length=6, max_length=128
    )
    # 要点1【粉丝画像】：年龄、职业、地域、核心需求、偏好、禁忌等
    fan_profile: Optional[str] = Field(
        default=None, description="粉丝画像（年龄/职业/地域/需求/偏好/禁忌等）"
    ...
    tag_ids: Optional[List[int]] = Field(
        default=None, description="用户标签ID列表（用于分类管理）"
    )
...
class SubUserUpdate(BaseModel):
    ...
    display_name: Optional[str] = Field(
        default=None, description="自定义昵称", max_length=100
    )
    status: Optional[str] = Field(
        default=None, description="状态：online / offline / disabled"
    )
...
class SubUserResponse(SubUserBase, BaseSchema):
    ...
    managed_by: Optional[int] = Field(
        default=None, description="当前管理者创作管理员ID"
    )
    wechat_openid: Optional[str] = Field(default=None, description="微信OpenID")
    wechat_unionid: Optional[str] = Field(default=None, description="微信UnionID")
    last_login_at: Optional[datetime] = Field(default=None, description="最后登录时间")
